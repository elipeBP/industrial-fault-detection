# Avaliação de Métricas em Modelos de Classificação Desbalanceada

Trabalho Prático — Engenharia de Dados e MLOps (UniSENAI). Pipeline reprodutível
que gera dados sintéticos de sensores industriais fortemente desbalanceados
(99,5% Operacional vs. 0,5% Falha), treina um classificador, compara métricas de
avaliação e realiza o ajuste dinâmico do threshold de decisão com base em custo
financeiro, gerando um Relatório Executivo em PDF.
